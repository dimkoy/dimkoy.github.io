...
export const projects: Project[] = [
  {
    ...
    price: "9.99",
    tech: ["Swift", "SwiftUI", "RealityKit", "visionOS", "GameKit", "Swift Concurrency", "Claude Code"],
    links: [
    ...
    i18n: {
      en: {
        ...
        highlights: [
          "Spatial 3D globe in RealityKit: territory, fog of war and radar coverage are equirectangular textures on thin concentric spheres instead of overlapping meshes",
          "Deterministic lockstep multiplayer over Game Center (GKMatch): authoritative host, tick frames",
      ...
      ru: {
        ...
        description: [
          ...
          "Внутри — Swift, SwiftUI и RealityKit, без игрового движка. Симуляция живёт в отдельном Swift-пакете с фиксированным тиком; рендер только интерполирует то, что ему отдали. Мультиплеер — детерминированный lockstep поверх Game Center: хост авторитетен, клиенты шагают только по полученным тик-кадрам.",
        ...
        highlights: [
          "Пространственный 3D-глобус в RealityKit: территории, туман войны и покрытие радаров — эквиректангулярные текстуры на тонких концентрических сферах вместо пересекающихся мешей",
          "Детерминированный lockstep-мультиплеер поверх Game Center (GKMatch): авторитетный хост, тик-кадры",
      ...
      es: {
        ...
        highlights: [
          "Globo 3D espacial en RealityKit: territorio, niebla de guerra y cobertura de radar son texturas equirectangulares sobre finas esferas concéntricas en lugar de mallas superpuestas",
          "Multijugador lockstep determinista sobre Game Center (GKMatch): anfitrión autoritativo, tick frames",
